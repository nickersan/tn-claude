...
Dispatches a message to an email address or a phone number, behind one interface,
so consuming services never integrate with an SMS/email provider directly.
